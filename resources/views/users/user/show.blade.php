...
<ul class="flex space-x-2 rtl:space-x-reverse">
    <li>
        <a href="{{ route('users.index') }}" class="text-primary hover:underline">User</a>
    </li>
    ...
    <div class="mb-5 grid grid-cols-1 gap-5 lg:grid-cols-3 xl:grid-cols-4">
        <div class="panel">
            <div class="mb-5 flex items-center justify-between">
                ...
                <a href="{{ route('users.edit',$user->id) }}" class="btn btn-warning rounded-full p-2 ltr:ml-auto rtl:mr-auto">
            ...
            <div class="mb-5">
                <div class="flex flex-col items-center justify-center">
                    <img src="{{ asset('assets/admin/assets/images/profile-34.jpeg')}}" alt="image" class="mb-5 h-24 w-24 rounded-full object-cover">
                    <p class="text-xl font-semibold text-primary">{{ $user->name }}</p>
                </div>
        ...
        <div class="panel lg:col-span-2 xl:col-span-3">
            <div class=" h-full pb-0 sm:col-span-2 xl:col-span-1">
                <h5 class="mb-5 text-lg font-semibold dark:text-white-light">Recent Activities</h5>

                <div class="perfect-scrollbar relative mb-4 -mr-3 h-[290px] pr-3 ps ps--active-y">
                    ...
                    <div class="ps__rail-y" style="top: 0px; height: 290px; right: 0px;">
