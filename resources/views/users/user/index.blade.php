        ...
        <div class="panel">
            <div class="mb-4 flex flex-col items-center justify-center sm:flex-row sm:justify-between">
                <div class="mb-4 sm:mb-0">
                    <div class="text-center text-lg font-semibold ltr:sm:text-left rtl:sm:text-right">Users</div>
                    <div class="mt-2 flex flex-wrap items-center justify-center sm:justify-start">
                        ...
                        <div class="flex items-center ltr:mr-4">
                ...
                @can('role-create')
                <a href="{{ route('users.create') }}" type="button" class="btn btn-primary" @click="editEvent()">
                    ...
                    <table id="myTable" class="table-hover whitespace-nowrap dataTable-table">
                        <thead>
                            <tr>
                                ...
                                <th data-sortable="false" style="width: 18.383%;">Email</th>
                                <th data-sortable="" style="width: 20.3404%;"><a href="#" class="dataTable-sorter">Role</a></th>
                                <th data-sortable="false" style="width: 11.234%;">Status</th>
                                <th data-sortable="false" style="width: 11.234%;">created at</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex items-center gap-2">
                                        <img src="{{ asset('assets/admin/assets/images/profile-10.jpeg')}}" class="w-9 h-9 rounded-full max-w-none" alt="user-profile">
                                ...
                                <td>
                                    <div class="flex items-center gap-2">
                                        <div>@if(!empty($user->getRoleNames()))
                                ...
                                <td>
                                    <ul class="flex items-center justify-center gap-2">
                                        ...
                                        <li>
                                            <a class="flex h-8 w-8 items-center justify-center rounded-full bg-primary text-white shadow shadow-secondary" href="{{ route('users.show',$user->id) }}" x-tooltip="View">
                                        ...
                                        <li>
                                            @can('role-edit')
                                            <a class="flex h-8 w-8 items-center justify-center rounded-full bg-warning text-white shadow shadow-secondary" href="{{ route('users.edit',$user->id) }}" x-tooltip="Edit">
