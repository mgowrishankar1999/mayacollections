                    ...
                    <tbody class="fw-semibold text-gray-600">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="#" data-id="{{ $user->id }}" data-name="2" data-bs-toggle="tooltip" data-bs-placement="top" title="Reject" class="btn accept-decline update-btn btn-icon btn-bg-light btn-active-color-primary btn-sm">

                                    <i class="ki-duotone ki-dislike fs-2 text-danger"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></i> </a>
