                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <td>Images</td>
                                <td><img src="{{ asset('assets/user/images/cart/img-1.jpg')}}" alt=""></td>
                                <td><img src="{{ asset('assets/user/images/cart/img-2.jpg')}}" alt=""></td>
                                <td><img src="{{ asset('assets/user/images/cart/img-3.jpg')}}" alt=""></td>
                                <td><img src="{{ asset('assets/user/images/cart/img-4.jpg')}}" alt=""></td>
                            </tr>
                            <tr>
                                <td>Categories</td>
                                <td>Fashion</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a data-bs-toggle="tooltip" data-bs-html="true" title="" href="#"
                                        data-bs-original-title="Remove from Cart" aria-label="Remove from Cart">
